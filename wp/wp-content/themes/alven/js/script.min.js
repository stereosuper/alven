...
if(W.hasClass("single-job")){var a=$(".js-job-details-tab");a.length&&a.on("click","h2",function e(){if(window.innerWidth<=767){var t=$(this).parent(),i=0;t.hasClass("active")?i=$(this).outerHeight(!0):t.children().each(function e(t,n){i+=$(n).outerHeight(!0)}),t.css({maxHeight:i}),t.toggleClass("active")}})}}(),isMobile.any?B.addClass("is-mobile"):B.addClass("is-desktop"),W.hasClass("home")||a(S,0),t(),z.length&&z.each(function(e){z.eq(e).html(setBtn(z.eq(e)))}),L.length&&L.each(function(e){L.eq(e).html(setBtn(L.eq(e)))}),E.length){var pe;if(E.find("img").length)r(E.find("img").not(".no-scroll"));E.find(".special-cat").length&&r(E.find(".special-cat"))}if(U.length&&(postSidebarTop=U.offset().top,postSidebarWidth=U.innerWidth()),R.length&&(s(),TweenMax.set(R.find(".spotlight-post"),{y:"-120%"}),new ScrollMagic.Scene({triggerElement:"#spotlightPost"}).triggerHook(.9).setTween(TweenMax.staggerTo(R.find(".spotlight-post"),.25,{y:"0%"},.1)).addTo(I)),X.length){var me=X.find(".read-also-post");TweenMax.set(me,{opacity:0}),new ScrollMagic.Scene({triggerElement:"#related"}).triggerHook(.7).setTween(TweenMax.staggerTo(me,.25,{opacity:1},.1)).addTo(I)}if(_.length){var ge=_.find("li"),ue=ge.length,be=767<O?6:3,ve=[];window.location.search&&(
