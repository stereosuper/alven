                            ...
                            if( $is_details ):
                                echo '<div class="details-job flex-container">';
                                    echo '<div class="details-job-main">';
                                        ...
                                        $details_header .= '<div><p>'.__('Job Type','alven').'</p><p>Permanent Contract</p></div>';
                                        $details_header .= '<div><p>'.__('Location','alven').'</p><p>Paris</p></div>';
                                        $details_header .= '</header>';
                                        echo $details_header;
                                    ...
                                    echo '<div class="details-job-sidebar">';
                                        if( $urlapply ):
                                            echo '<a href="'.$urlapply.'" alt="'.__('Apply','alven').'" tarrget="_blank" rel="noopener noreferrer">'.__('Apply','alven').'</a>';
                                        endif;
                                        $job_company  = '<div>';
                                        $job_company .= '<p>'.__('The company','alven').'</p>';
                                        $job_company .= '<img src="'.$company_datas['logo_url'].'" alt="'.$company_datas['name'].'">';
                                        $job_company .= '<p>'.__('Sectors','alven').'</p>';
